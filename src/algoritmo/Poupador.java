...
//			}
	...
	double PARAMETRO_LADRAO_DOIS = 160000;
	...
	void ajustarParametros() {
		if (quantVezesRoubado > quantVezesRoubadoAnterior) {
			PARAMETRO_LADRAO_UM *= 1.15;
			PARAMETRO_LADRAO_DOIS *= 1.13;
			PARAMETRO_LADRAO_TRES *= 1.12;
			PARAMETRO_LADRAO_QUATRO *= 1.1;

			PARAMETRO_OLFATO_LADRAO_UM *= 1.15;
			PARAMETRO_OLFATO_LADRAO_DOIS *= 1.13;
			PARAMETRO_OLFATO_LADRAO_TRES *= 1.12;
			PARAMETRO_OLFATO_LADRAO_QUATRO *= 1.11;
			PARAMETRO_OLFATO_LADRAO_CINCO *= 1.1;

			PARAMETRO_IR_BANCO *= 1.25;

			PARAMETRO_PASTILHA_PODER_UM *= 1.16;
			PARAMETRO_PASTILHA_PODER_DOIS *= 1.13;
			PARAMETRO_PASTILHA_PODER_TRES *= 1.12;
			PARAMETRO_PASTILHA_PODER_QUATRO *= 1.1;

			PARAMETRO_POUPADOR_UM *= 1.15;
			PARAMETRO_POUPADOR_DOIS *= 1.13;
			PARAMETRO_POUPADOR_TRES *= 1.12;
			PARAMETRO_POUPADOR_QUATRO *= 1.1;

		}

		if (quantTempoSemSerRoubado > quantTempoSemSerRoubadoAnterior) {
			PARAMETRO_ESPACO_VAZIO_NOVO *= 1.003;
			PARAMETRO_ESPACO_VAZIO *= 1.0015;

			PARAMETRO_MOEDA_UM *= 1.008;
			PARAMETRO_MOEDA_DOIS *= 1.006;
			PARAMETRO_MOEDA_TRES *= 1.004;
			PARAMETRO_MOEDA_QUATRO *= 1.003;
